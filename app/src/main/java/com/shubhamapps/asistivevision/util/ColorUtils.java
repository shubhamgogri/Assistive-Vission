...
public class ColorUtils {
    ...
    public String getColorNameFromRgb(int r, int g, int b) {
        ...
        Log.d("TAG", "getColorNameFromRgb: color "+ closestMatch.getName());
    ...
    public String getColorNameFromHex(int hexColor) {
        ...
        int b = (hexColor & 0xFF);
        String colorNameFromRgb = getColorNameFromRgb(r, g, b);
        Log.d("TAG", "getColorNameFromHex: Color hex " + colorNameFromRgb);
